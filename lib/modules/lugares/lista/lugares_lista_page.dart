...
import 'package:app_san_isidro/modules/lugares/lista/lugares_lista_controller.dart';
...
class LugaresListaPage extends StatelessWidget {
  final _conX = Get.put(LugaresListaController());
            ...
            Obx(
              () => _conX.fetchingTipos.value
                  ...
                  : FadeIn(
                      key: ValueKey('fiCg2'),
                      duration: Duration(milliseconds: 300),
                      child: GetBuilder<LugaresListaController>(
                          id: _conX.gbTiposList,
                          builder: (_) => _CategorySelector(_conX)),
                    ),
            ),
            ...
            Expanded(
              child: Container(
                ...
                child: Obx(
                  () => AnimatedSwitcher(
                    duration: Duration(milliseconds: 300),
                    child: _conX.fetchingLugares.value
                        ? _ResultSkeletonList()
      ...
      child: IntrinsicHeight(
        child: Row(
          children: [
            ...
            SlideCategoryItem(placeHolder: true),
            SlideCategoryItem(placeHolder: true),
            SlideCategoryItem(placeHolder: true),
            SlideCategoryItem(placeHolder: true),
            SizedBox(
...
class _CategorySelector extends StatelessWidget {
  final LugaresListaController _conX;
  ...
  Widget build(BuildContext context) {
    ...
    _conX.tipos.forEach((t) {
      items.add(SlideCategoryItem(
        ...
        onTap: () {
          _conX.onCategoryItemTap(t.codigoTipo);
        },
      ));
    });
...
class _ResultList extends StatelessWidget {
  final LugaresListaController conX;

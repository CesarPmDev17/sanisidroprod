...
class ViewPdfPage extends StatelessWidget {
  final _conX = Get.put(ViewPdfViewController(
    pageName: (Get.arguments as ViewPdfArguments).pageName,
    pdfBytes: (Get.arguments as ViewPdfArguments).pdfBytes,
    urlPDF: (Get.arguments as ViewPdfArguments).urlPDF,
  ));
              ...
              child: Stack(
                children: [
                  Container(
                      ...
                      child: GetBuilder<ViewPdfViewController>(
...
class _PageCounter extends StatelessWidget {
  final ViewPdfViewController conX;

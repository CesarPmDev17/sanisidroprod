import 'package:app_san_isidro/modules/pagos/estado_cuenta/pagos_estado_cuenta_controller.dart';
...
class PagosEstadoCuentaPage extends StatelessWidget {
  final _conX = Get.put(PagosEstadoCuentaController());
              ...
              child: Stack(
                children: [
                  Container(
                      ...
                      child: GetBuilder<PagosEstadoCuentaController>(
...
class _PageCounter extends StatelessWidget {
  final PagosEstadoCuentaController conX;

...
class FinishPaymentPage extends StatelessWidget {
  final _conX = Get.put(FinishPaymentController(
    Get.arguments as FinishPaymentArguments,
  ));
            ...
            child: Container(
              ...
              child: Column(
                children: [
                  ...
                  _CardData(_conX),
                  SizedBox(height: 30.0),
                  _conX.successPayment && _conX.showButtonConstancy
                      ? AkButton(
                          enableMargin: false,
                          fluid: true,
...
class _CardData extends StatelessWidget {
  final FinishPaymentController conX;
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          _FieldItem('Nro. pedido', conX.numOrden),
